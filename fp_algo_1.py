#Fingerprint Method : K Nearest Neighbors
import numpy as np
import cv2
import glob
...
def compare_fingerprints(classifier, path_a, path_b, similarity_threshold=0.31, debug=False):
    ...
    # Determine if the fingerprints are alike
...
def main():
    ...
    # compare the test values with itself or another value
    for i in range(500):
        ...
        # combine it with a random variable
        else:
